...
:class: sim sim-m
:width: 100%
Las corridas de Toluca, con la recta reajustándose mientras arrastras. **Qué observar:** la pendiente
b1 es la descripción y Yhat es la predicción, y un solo punto arrastrado mueve ambas. **Prueba
esto:** compara cuánto se mueve Yhat en un lote de 100 frente a Yhat en un lote de 200, un tamaño que
nadie produjo nunca. Volver a la [Sección 1.1](#ch01-what-es).
```
...
:class: sim sim-m
:width: 100%
La recta de Galton frente a la recta de estaturas iguales, con un deslizador para la estatura media
de los padres. **Qué observar:** el hijo predicho siempre queda entre sus padres y el promedio, de
cualquier lado. **Prueba esto:** desliza de 75 pulgadas a 65 y observa que la fracción conservada se
mantiene en 0.637 todo el camino. Volver a la [Sección 1.2](#ch01-galton-es).
```
...
:class: sim sim-m
:width: 100%
Veinte lanzamientos de una moneda justa, repetidos en tantas rondas como quieras. **Qué observar:**
el conteo casi nunca cae en diez, y aun así el montón que forma es perfectamente ordenado. **Prueba
esto:** corre 1000 rondas y observa que la media se asienta cerca de 10 mientras la dispersión se
queda cerca de 2.24, que es el término de error descrito en vez de eliminado. Volver a la
[Sección 1.3](#ch01-anatomy-es).
```
