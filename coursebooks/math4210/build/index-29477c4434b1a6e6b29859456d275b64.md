...
Este libro esta disponible capitulo por capitulo en espanol. Cada capitulo en
ingles tiene un enlace "Espanol" en la esquina superior derecha de la pagina, y
cada version en espanol tiene un enlace "English" de regreso al ingles en el
mismo lugar. Puedes encontrar
todos los capitulos en espanol reunidos en [Version en espanol](ch01/es.md),
la ultima parte de la tabla de contenidos.
